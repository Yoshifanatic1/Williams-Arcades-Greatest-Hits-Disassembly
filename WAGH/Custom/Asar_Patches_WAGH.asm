; Note: Put your custom routine/data macros, references to them, and defines in this file from within the WAGH_InsertIntegratedPatches and WAGH_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro WAGH_InsertIntegratedPatches()
...
macro WAGH_ApplyPatchesPostAssembly()
